...
1. Finally, it uses the [`Message`](xref:Microsoft.Quantum.Intrinsic.Message) function to print an explanatory message in the console before returning the results.

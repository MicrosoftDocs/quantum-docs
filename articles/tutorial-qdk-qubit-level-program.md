...
* Create a Q# project for either a [Q# application](xref:microsoft.quantum.submit-jobs?pivots=ide-azurecli) or a [C# host program](xref:microsoft.quantum.how-to.csharp-local). Alternatively, you can run your Q# code from a [Python host program](xref:microsoft.quantum.how-to.python-local).

...
The profiling feature creates a resource estimation profile that shows how the subroutine operations in the program contribute to the overall costs.

There are two important outputs of a resource estimation profile, a call graph and a call tree.

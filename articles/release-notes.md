...
- Added a [tool](https://github.com/microsoft/qsharp-compiler/tree/main/src/QsFmt) to update deprecated Q# syntax and basic formatting for Q# projects with QDK version 0.21.2111.xxxxxx and up:
...
- Added support for submitting problems to a subset of Microsoft targets in [protobuf binary format](https://docs.microsoft.com/azure/quantum/optimization-problem). You can use it for encoding significantly large problems by reducing the payload sizes, and improve upload and processing speeds.

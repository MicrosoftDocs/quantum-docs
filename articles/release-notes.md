...
- Added support for [Rigetti](microsoft.quantum.providers.rigetti) in Azure Quantum, that includes the Rigetti [Aspen-M-2](microsoft.quantum.providers.rigetti#aspen-m-2), [Aspen-11](microsoft.quantum.providers.rigetti#aspen-11) and [Quantum Virtual Machine](microsoft.quantum.providers.rigetti#simulators).
- Updated all Microsoft Quantum Development Kit components to Python 3.9.
- The [Quantinuum target names](microsoft.quantum.providers.quantinuum) have been updated for clarity and consistency. The old target names will continue to be available.

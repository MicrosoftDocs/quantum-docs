...
- Breaking change: Fixed GitHub issue [microsoft/qdk-python#246](https://github.com/microsoft/qdk-python/pull/246). For the azure-quantum Python package, you can now pass `shots` to `backend.run` and `backend.estimate_cost` for all backends.

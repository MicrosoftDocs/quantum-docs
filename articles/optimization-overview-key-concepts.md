...
Professor Andrew Lucas' paper "Ising formulations of many NP problems" is a good summary about how to convert a NP problem to QIO's QUBO or Ising model. You can download the paper from internet.

...
Up to date information on the various limits for each Microsoft QIO pricing SKU are available via the general Azure [subscription limits, quotas, and constraints](/azure-docs/blob/master/articles/azure-resource-manager/management/azure-subscription-service-limits#azure-quantum-limits) article. 

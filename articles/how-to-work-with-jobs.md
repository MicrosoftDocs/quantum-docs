...
You typically create jobs for either [quantum computing](xref:microsoft.quantum.overview.qdk-overview) or [quantum inspired optimization(QIO)](xref:microsoft.quantum.optimization.overview.what-is-qio). Once you've written

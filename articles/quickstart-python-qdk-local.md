...
ms.topic: quickstart
no-loc: ['Q#', '$$v']
title: Quickstart - Run a Q# and Python program on a local quantum simulator
uid: microsoft.quantum.quickstarts.python-local
---

# Quickstart: Run a Q# and Python program on a local quantum simulator

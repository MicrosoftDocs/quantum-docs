...
| **QDK: Create a Microsoft Quantum notebook** | Opens a sample Jupyter Notebook that runs a Q# + Python program and submits a job to Azure Quantum. | For more information about the QDK in Jupyter Notebook, see [Submit jobs to Azure Quantum from Jupyter Notebook](https://learn.microsoft.com/en-us/azure/quantum/how-to-submit-jobs?tabs=tabid-python&pivots=ide-jupyter#submit-jobs-to-azure-quantum-from-jupyter-notebook). | N/A |

...
Quantum computers promise to solve some scientifically and commercially valuable problems, accomplish this will require a large-scale, fault-tolerant quantum computer. 
...
One of the applications of quantum algorithms with scientific and commercial interest is the efficiently simulation of quantum systems such as complex molecules, and chemical reactions, which often involve many-body quantum interactions. The simulation time of the dynamics of quantum systems scales exponentially with classical algorithms, but has a polynomial scaling for quantum algorithms. 

...
| IonQ Harmony |<ul><li>1-Qubit Gate Shot: $0.00003 (USD) deducted from your credits</li><li>2-Qubit Gate Shot: $0.0003 (USD) deducted from your credits</li><li>Minimum price per program execution: $1 (USD) if error mitigation is off, $5 (USD) if error mitigation is on.</ul>|
...
| IonQ Harmony |<ul><li>1-Qubit Gate Shot: $0.00003 (USD)</li><li>2-Qubit Gate Shot: $0.0003 (USD)</li><li>Minimum price per program execution: $1 (USD) if error mitigation is off, $5 (USD) if error mitigation is on.</li></ul>|

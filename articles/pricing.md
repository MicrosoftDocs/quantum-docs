...
|---|---|  
|<ul><li>3,000€/QPU hour + Azure infrastructure costs</li><li>15€/EMU hour + Azure infrastructure costs </li></ul> | <ul><li>PASQAL FRESNEL, FRESNEL_CAN1 QPUs</li><li>PASQAL EMU-MPS, EMU-SV, EMU-TN (deprecated) emulators</li></ul>|

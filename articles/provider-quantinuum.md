...
ms.topic: conceptual
no-loc: [QIR Adaptative RI, target, targets]
...
- Target Execution Profile: [QIR Adaptative RI](xref:microsoft.quantum.target-profiles)
...
- Target Execution Profile: [:::no-loc text="QIR Adaptative RI":::](xref:microsoft.quantum.target-profiles)

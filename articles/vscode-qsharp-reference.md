...
| **QDK: Show Changelog** | Opens a changelog in a new tab that shows the QDK updates for the current and all previous release versions.| The changelog is also available on the open-source [QKD GitHub repository](https://github.com/microsoft/qdk). | N/A |

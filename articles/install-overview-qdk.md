...
ms.topic: quickstart
no-loc: ['Q#', '$$v']
title: Configure your quantum development environment 
uid: microsoft.quantum.install-qdk.overview
---

# Configure your quantum development environment 

Learn about the different environment options available to develop quantum computing and optimization applications for [Azure Quantum](xref:microsoft.quantum.azure-quantum-overview).

Every environment uses the [Quantum Development Kit (QDK)](xref:microsoft.quantum.overview.q-sharp), an open-source set of tools that includes the quantum programming language Q# and accompanying libraries. With the QDK, you can develop quantum computing applications using different IDEs and languages, and run them on local quantum simulators or quantum hardware using the Azure Quantum service. 
...
The Azure Quantum portal provides a built-in development environment where you can create, upload, store, and run your quantum code in Jupyter Notebooks, using both local simulator and quantum hardware targets. A gallery of sample Jupyter Notebooks is provided to get you started with quantum programming in Q#, quantum optimization and running Qiskit and Cirq circuits.  From the portal, you can also manage quantum workspaces, jobs, activity, credits and usage, and access control. To get started, see [Create an Azure Quantum workspace](xref:microsoft.quantum.how-to.workspace). 
...
:::image type="content" source="./media/install-portal.svg" alt-text="Portal installation options":::
...
You can also run quantum programs and manage your Azure Quantum workspaces with the .NET CLI or the Azure CLI. 
...
To test your environment, see [Write a Q# and .NET program](xref:microsoft.quantum.how-to.csharp-local).
...
To test your environment, see [Submit Q# jobs to Azure Quantum](xref:microsoft.quantum.submit-jobs).

## Other options

You can also develop Q# programs locally and run them on local simulators (no Azure subscription required), in an online Binder environment, or using a Docker image.

### Use your preferred IDE and language locally and submit jobs to local simulators

You can use the QDK locally without an Azure subscription and still leverage all the IDE and language extensions and test your code on any of the local simulators and resource estimators. 

:::image type="content" source="./media/install-local.svg" alt-text="Local installation options":::

Some scenarios where you may prefer a local-only environment:

- You only require access to local simulators and not to quantum hardware through the Azure Quantum service. 
- You have limitations that prevent access to the Azure Quantum service. 

### Use the QDK with a temporary Binder environment

Binder offers a free online Jupyter Notebook experience to run and share Jupyter Notebooks and Q# console applications online, allowing you to try Q# without installing the QDK. For more information, see [Using Binder online](xref:microsoft.quantum.install-qdk.overview.binder).
